...
import { getCPOsVideos, getDashboardVideos,getUtilitiesVideos } from "../../store/action/mapAction";
...
export default function CPOs() {
  ...
  const { Videos, cposVideos } = useSelector((state) => state?.map);
  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`https://aboutvehya.com/CPOs`}
        openGraph={{
          type: "article",
          url: `https://aboutvehya.com/CPOs`,
          title: 'Vehya',
          description: 'Vehya is the premier app for electrical contractors and electricians looking to expand their services to the rapidly growing electric vehicle market. With the ability to serve customers globally and access to in-app training programs for everyone to become an EV service provider, you can be sure that you have the skills and knowledge necessary to provide top-notch service.',
          images: [
            {
        ...
        <div className="container-padding">
          ...
          <Row>
            {/* <Col md="5 d-flex flex-column justify-content-center align-items-start">
              ...
              >
                The Future of Mobility Relies on Strong CPO Partnerships
              </h3>
              <p className="font-archivo">
                {/* As EV adoption surges, CPOs play a crucial role in building the
                essential infrastructure for a sustainable future. Explore the
                exciting opportunities and challenges shaping the EV charging
                landscape */}
                {/* Charge Point Operators (CPOs) are at the forefront of accelerating electric vehicle (EV) integration. 
                Vehya stands as a pivotal ally for these entities, offering a comprehensive, turnkey solution that streamlines 
                the distribution of Electric Vehicle Supply Equipment (EVSE), parts, customer support, and contractor coordination. 
                Our innovative platform ensures a seamless operational experience for CPOs.
            ...
            {/* <Col md= "7"> 
              <div>
                {Videos && Videos.Videos && Videos.Videos.length > 0 && (
                  ...
                  {cposVideos && cposVideos.Videos && cposVideos.Videos.length > 0 && (
                    <iframe
                      width="100%"
                      height="456px"
                      // flexShrink="0"
                      src={"https://www.youtube.com/embed/KS4w3VyuGA4?si=FX8dh5c7RBSsv38b"}
                      className=" video"
                    ></iframe>
          ...
          <Row>
                {	cposVideos &&
                  cposVideos?.Videos &&
                  cposVideos?.Videos.map((filtered) => { 
                    return (
          ...
          <Row className="popular-article pl-3">
            {cposVideos &&
              cposVideos?.Videos &&
              cposVideos?.Videos.map((filtered) => {
                return (
                  filtered.isIntroVideo === false &&
                  <Col className="responsive-margin-bottom pl-0 pr-3" md="4" sm="6">
                    <iframe
              ...
              <source src={item?.video} type="video/mp4" />
                    ...
                    <h6 className="popular-article__header font-poppins card-header-text"
                    >
                      {filtered?.Title}
                    </h6>
          ...
          <Row className="mt-2 pl-0 mb-3">
            ...
            >
              <h2
                ...
                Drive Positive Change with Your Charging Network
              </h2>
              <p className="font-archivo mb-3 mb-lg-0 mb-xl-0">
                We believe in building charging networks that not just generate
                revenue, but also contribute to a cleaner and more sustainable
                future. Let's collaborate to make a positive impact on the world
            ...
            <Col lg={6} sm={6} md={12} className="padding-left-responsive">
              <Row className="pl-3 pl-xl-0 pl-lg-0">
                <Col lg={4} md={4} xs={6} className="pr-3 pl-0 mb-lg-0 mb-3 mb-md-0">
                  <div className="feature-img-div">
                    <img src="/CPO_img_1.png" className="img-fluid feature-img "/>
                ...
                <Col lg={4} md={4} xs={6} className="pr-3 pl-0 mb-lg-0 mb-3 mb-md-0">
                  <div className="feature-img-div">
                    <img src="/CPO_img_2.png" className="img-fluid feature-img " />
                    <div className="feature-img-overlay">
                    <p className="feature-img-text">Community Engagement & Equity</p>
                    </div>
                ...
                <Col lg={4} md={4} xs={6} className="pr-3 pl-0">
                  <div className="feature-img-div">
                    <img src="/CPO_img_3.png" className="img-fluid feature-img"/>
                    <div className="feature-img-overlay">
                    <p className="feature-img-text">Sustainability Reporting & Transparency</p>
                    </div>
                  </div>
                </Col>
              </Row>
